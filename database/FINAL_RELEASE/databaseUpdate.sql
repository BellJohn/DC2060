...
-- Directory within tomcat\webapps
INSERT INTO reach_out.SYSTEM_PROPERTIES (SP_NAME, SP_VALUE) VALUES ("IMAGE_DIR", "images");
-- Tomcat Root (Check logs)
...
INSERT INTO reach_out.SYSTEM_PROPERTIES (SP_NAME, SP_VALUE) VALUES ("EMAIL_ACC", "changeme");
INSERT INTO reach_out.SYSTEM_PROPERTIES (SP_NAME, SP_VALUE) VALUES ("EMAIL_PASS", "changeme");

DROP TABLE IF EXISTS reach_out.ALL_GROUPS;
CREATE TABLE reach_out.ALL_GROUPS(
G_ID int(11) NOT NULL AUTO_INCREMENT,
G_NAME varchar(200) UNIQUE NOT NULL,
G_DESC varchar(400) NOT NULL,
G_LOC_ID int(11) NOT NULL,
G_CITY varchar(200) NOT NULL,
G_COUNTY varchar(200) NOT NULL,
G_PICTURE varchar(250) NOT NULL,
PRIMARY KEY(G_ID)
);
...
ALTER TABLE reach_out.LISTINGS
ADD COLUMN LST_LOC_ID INT(11) NOT NULL AFTER LST_VISIBILITY;

ALTER TABLE reach_out.LISTINGS
ADD COLUMN LST_STREET VARCHAR(200) NOT NULL AFTER LST_LOC_ID;

DROP TABLE IF EXISTS reach_out.LOCATIONS;
CREATE TABLE reach_out.LOCATIONS (
