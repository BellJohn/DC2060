						...
						<div class="card card-bkg">
							...
							<form action="" method="POST" id="editGroup"
								...
								<div class="form-group">
									<label for="Group">Group Name</label> <input id="Name"
										name="Name" placeholder="Name" type="text" required="required"
										class="form-control" value="${group.name}" maxlength="128"
										minlength="10">
								</div>
								...
								<div class="form-group">
									<label for="groupPicture">Group Picture (optional)</label><input
										type="file" id="groupPicture" name="groupPicture"
										class="form-control">
								</div>
								...
								<div class="form-group">
									<label for="groupCity">City/Town of Group (e.g.
										...
										class="form-control" maxlength="60" value="${group.city}">
								</div>
								...
								<div class="form-group">
									<label for="groupCounty">County of Group (e.g.
										...
										required="required" maxlength="30" value="${group.county}">
								</div>
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${changeSuccess}">
								<div class="alert alert-success" role="alert">The group
